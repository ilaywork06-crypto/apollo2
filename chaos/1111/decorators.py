...
def process_invoice(invoice_id, amount, currency):
...
def send_webhook(endpoint, payload, secret):
...
class ServiceClient:
    ...
    def from_env():
        import os
        return ServiceClient(os.getenv("SERVICE_URL", "http://localhost:8000"), os.getenv("SERVICE_TOKEN", ""))
